...
public class CommandmentService extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "getCommandment".
   *
   * This request holds the parameters needed by the commandmentService server.  After setting any
   * optional parameters, call the {@link GetCommandment#execute()} method to invoke the remote
   * operation.
   *
   * @param id
   * @param active
   * @return the request
   */
  public GetCommandment getCommandment(java.lang.Long id, java.lang.Boolean active) throws java.io.IOException {
    GetCommandment result = new GetCommandment(id, active);
    initialize(result);
    return result;
  }

  public class GetCommandment extends CommandmentServiceRequest<com.virtualef.pgj.service.commandmentService.model.CommandmentDto> {

    private static final String REST_PATH = "commandmentdto/{id}/{active}";

    /**
     * Create a request for the method "getCommandment".
     *
     * This request holds the parameters needed by the the commandmentService server.  After setting
     * any optional parameters, call the {@link GetCommandment#execute()} method to invoke the remote
     * operation. <p> {@link GetCommandment#initialize(com.google.api.client.googleapis.services.Abstr
     ...
     * @since 1.13
     */
    protected GetCommandment(java.lang.Long id, java.lang.Boolean active) {
      super(CommandmentService.this, "GET", REST_PATH, null, com.virtualef.pgj.service.commandmentService.model.CommandmentDto.class);
    ...
    @Override
    public GetCommandment setAlt(java.lang.String alt) {
      return (GetCommandment) super.setAlt(alt);
    }

    @Override
    public GetCommandment setFields(java.lang.String fields) {
      return (GetCommandment) super.setFields(fields);
    }

    @Override
    public GetCommandment setKey(java.lang.String key) {
      return (GetCommandment) super.setKey(key);
    }

    @Override
    public GetCommandment setOauthToken(java.lang.String oauthToken) {
      return (GetCommandment) super.setOauthToken(oauthToken);
    }

    @Override
    public GetCommandment setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetCommandment) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetCommandment setQuotaUser(java.lang.String quotaUser) {
      return (GetCommandment) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetCommandment setUserIp(java.lang.String userIp) {
      return (GetCommandment) super.setUserIp(userIp);
    }
    ...
    public GetCommandment setId(java.lang.Long id) {
      this.id = id;
      return this;
    }
    ...
    public GetCommandment setActive(java.lang.Boolean active) {
      this.active = active;
      return this;
    }

    @Override
    public GetCommandment set(String parameterName, Object value) {
      return (GetCommandment) super.set(parameterName, value);
    }
  }
