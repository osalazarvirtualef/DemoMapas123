...
public class Constants {
	...
	public static final  int MandamientosJudiciales = 1;
	public static final  int Documentos = 2;
	public static final  int Emergencias = 3;
	public static final  int TransmitirBitacora = 4;
	public static final  int OrdenesAprehension = 5;
	public static final  int OrdenesReaprehension = 6;
	public static final  int OrdenesPresentacion = 7;
	public static final  int OrdenesComparecencia = 8;
	...
	public static final String userAgente = "";
	public static final String passAgente = "";
	public static final String Audio = "1";
	public static final String Imagen = "0";
